<?php 
    ...
    $kondektur = showData("SELECT * FROM kondektur");
?>
...
<body>
    ...
    <table class="table table-bordered border-black" style="margin-top: 30px;">
        ...
        <?php foreach($kondektur as $dataKondektur): ?>
        <tr style="background-color:#D8D8D8;">
            <td><?= $dataKondektur["id_kondektur"];  ?></td>
            <td style="padding: 10px;"><a style="color: black;"
                    href="updateKondektur.php?id_kondektur=<?=$dataKondektur["id_kondektur"]; ?>">Update</a> | <a
                    style="color: black;"
                    href="hapusKondektur.php?id_kondektur=<?=$dataKondektur["id_kondektur"]; ?>">Delete</a></td>
            <td><?= $dataKondektur["nama"];  ?></td>
        </tr>
        <?php endforeach; ?>
    </table>
</body>
