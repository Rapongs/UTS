<?php 
    ...
    $bus = showData("SELECT * FROM trans_upn");
?>
...
<body>
    ...
    <table class="table table-bordered border-black" style="margin-top: 30px;">
        ...
        <?php foreach($bus as $dataBus): ?>
        <tr style="background-color:#D8D8D8;">
            <td><?= $dataBus["id_trans_upn"];  ?></td>
            <td style="padding: 10px;"><a style="color: black;"
                    href="updateTransUpn.php?id_trans_upn=<?=$dataBus["id_trans_upn"]; ?>">Update</a> | <a
                    style="color: black;"
                    href="hapusTransUpn.php?id_trans_upn=<?=$dataBus["id_trans_upn"]; ?>">Delete</a>
            </td>
            <td><?= $dataBus["id_kondektur"];  ?></td>
            <td><?= $dataBus["id_bus"];  ?></td>
            <td><?= $dataBus["id_driver"];  ?></td>
            <td><?= $dataBus["jumlah_km"];  ?></td>
            <td><?= $dataBus["tanggal"];  ?></td>
        </tr>
        <?php endforeach; ?>
    </table>
</body>
